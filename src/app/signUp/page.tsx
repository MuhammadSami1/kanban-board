        ...
        <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
          <div>
            ...
            <input
              ...
              className="w-full rounded-md p-3 text-white border-[1px] border-gray-600 bg-foreground"
            />
            {errors.name && (
          ...
          <div>
            ...
            <input
              type="email"
              className="w-full rounded-md bg-foreground p-3 text-white border-[1px] border-gray-600"

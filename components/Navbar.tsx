const Navbar = () => {
  return (
    <>
      <nav className="bg-foreground p-5 sm:p-6">
        <div>
          <div className="flex justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="text-lg sm:text-2xl sm:ml-24 text-Neutral-Primary font-semibold">
                Example Board
              </div>
            ...
            <div className="flex items-center gap-7">
              <div className="bg-Primary-button px-4 py-2 md:px-5 md:py-3 md:rounded-3xl rounded-2xl">
                <svg
                  width="12"
                  height="12"
                  xmlns="http://www.w3.org/2000/svg"

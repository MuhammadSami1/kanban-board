const Sidebar = () => {
  return (
    <div className="w-[274px] md:w-[290px] border-r-[1px] border-gray-600 bg-foreground hidden sm:flex">
      <div className="flex flex-col flex-1 items-start text-Neutral-Secondary pb-7">
        <h2 className="pt-4 pb-6 pl-8 text-sm font-semibold">ALL BOARDS (3)</h2>

        <div className="flex flex-col">
          <div className="pl-8 md:pr-9 py-4 hover:bg-Neutral-Primary hover:text-Primary-button hover:rounded-r-full font-semibold group transition-all duration-700 ease-in-out">
          ...
          <div className="pl-8 pr-9 py-4 hover:bg-Neutral-Primary hover:text-Primary-button hover:rounded-r-full font-semibold group transition-all duration-700 ease-in-out">
            <div className="flex items-center gap-x-4">
              <svg
                width="16"
                height="16"
        ...
        <div className="mt-auto">
          <div className="pl-8">
            <div className="bg-background flex items-center justify-between px-12 rounded-md py-4 gap-x-6">
          ...
          <div className="pl-8 pr-14 hover:bg-Neutral-Primary py-4 hover:text-Primary-button rounded-r-full group transition-all duration-700 ease-in-out">
